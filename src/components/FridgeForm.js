    ...
    return(
      <div className="fridge-form">
        ...
        <form onSubmit={this.handleFridgeSubmit}>
          <input type="text" value={this.state.fridge_item} onChange={this.handleFridgeItemChange} placeholder="new refrigerator item"/><br/>
          <input type="text" value={this.state.fridge_category} onChange={this.handleFridgeCategoryChange} placeholder="category"/><br/>
          <input type="text" value={this.state.fridge_quantity} onChange={this.handleFridgeQuantityChange} placeholder="quantity"/><br/>
          <input type="text" value={this.state.fridge_unit} onChange={this.handleFridgeUnitChange} placeholder="unit"/><br/>
